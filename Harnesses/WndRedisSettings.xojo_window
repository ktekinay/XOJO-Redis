...
#tag Events fldPassword
	...
	#tag EndEvent
#tag EndEvents
#tag Events fldAddress
	#tag Event
		Sub TextChange()
		  if me.Text.Trim = "" then
		    App.RedisAddress = Redis_MTC.kDefaultAddress
		  else
	...
	#tag Event
		Sub TextChange()
		  if me.Text.Trim = "" then
		    ...
		    App.RedisPort = me.Text.Val
		    if App.RedisPort = 0 then
		      App.RedisPort = Redis_MTC.kDefaultPort
		    end if
		  end if
